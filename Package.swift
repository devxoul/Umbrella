...
let package = Package(
  ...
  products: [
    ...
    .library(name: "UmbrellaAppMetrica", targets: ["UmbrellaAppMetrica"]),
  ],
  targets: [
    ...
    .target(name: "UmbrellaAppMetrica", dependencies: ["Umbrella"]),
    ...
    .testTarget(name: "UmbrellaAppMetricaTests", dependencies: ["UmbrellaAppMetrica"]),
  ]
)
