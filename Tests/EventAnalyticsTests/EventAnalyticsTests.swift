...
class EventAnalyticsTests: XCTestCase {
  ...
  func testAnalytics_multipleProvider() {
    ...
    XCTAssertEqual(self.fabricProvider.events.count, 2)
    ...
    XCTAssertEqual(self.fabricProvider.events[1].name, "Purchase")
    XCTAssertEqual(self.fabricProvider.events[1].parameters!.count, 2)
    XCTAssertEqual(self.fabricProvider.events[1].parameters!["Product ID"] as! Int, 123)
    XCTAssertEqual(self.fabricProvider.events[1].parameters!["Price"] as! Float, 99.9)
  }
}
